...
chatRoutes.post("/new", token_manager_js_1.verifyToken, chat_controllers_js_1.upload.single('image'), (0, validators_js_1.validate)(validators_js_1.chatCompletionValidator), chat_controllers_js_1.generateChatCompletion);
